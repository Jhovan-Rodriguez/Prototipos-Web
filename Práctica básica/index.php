        ...
        <div class="content-wrapper">
            ...
            <form action="insert.php" method="post">
                <p>
                    ...
                    <input type="number" min="0" name="codeProduct" id="code" placeholder="Ingrese ID del producto" required>
                </p>
                <p>
                ...
                <p>
                    ...
                    <input type="text" name="description" id="description" placeholder="Ingrese descripción del producto" required>
                </p>
                <p>
                    <label for="Categoria">Categoria:</label>
                    <select id="inputState" class="form-control select2 " name="category" required>
                            <?php if($datos == NULL){ ?>    
                                <option value=" ">Sin categorias</option>
                            <?php }else{ ?>
                                <option value="">Seleccione una categoria</option>
                            <?php foreach( $datos as $dato => $data ){ ?>
